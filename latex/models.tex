...
\begin{gathered}
\phi \bar{v}_{g}^*  = -\frac{k}{\mu_g} \frac{\Delta P_g^*}{\Delta L}
\end{gathered}
\end{eqnarray}
...
\begin{gathered}
\phi\bar{S}_w\bar{v}_{\omega} = -\frac{k k_{rw}}{\mu_w} \frac{\Delta P_{\omega}}{\Delta L}
\end{gathered}
\end{eqnarray}
...
\label{eq:gas_velocity}
\begin{gathered}
\phi\left(1-\bar{S}_w\right)\bar{v}_{g} = -\frac{k k_{rg}}{\mu_g} \frac{\Delta P_g}{\Delta L}
\end{gathered}
\end{eqnarray}
...
\label{eq:water_rel}
\begin{gathered}
k_{rw}=\bar{S}_w\frac{\mu_w}{\mu_g}\frac{\bar{v}_{\omega}}{\bar{v}_g^*} \frac{\Delta P_g^*}{\Delta P_{\omega}}
\end{gathered}
\end{eqnarray}
...
\label{eq:water_rel}
\begin{gathered}
k_{rg}=\left(1-\bar{S}_w\right)\frac{\bar{v}_{g}}{\bar{v}_g^*} \frac{\Delta P_g^*}{\Delta P_g}
\end{gathered}
\end{eqnarray}
