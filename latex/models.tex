...
\begin{eqnarray}
	...
	\begin{gathered}
		\phi \bar{v}^*  = -\frac{k}{\mu^*} \frac{\Delta P^*}{\Delta L}
	\end{gathered}
\end{eqnarray}
\begin{eqnarray}
...
\begin{eqnarray}
	\label{eq:water_rel}
	\begin{gathered}
		k_{rw}=\bar{S}_w\frac{\mu_w}{\mu^*}\frac{\bar{v}_{\omega}}{\bar{v}^*} \frac{\Delta P^*}{\Delta P_{\omega}}
	\end{gathered}
\end{eqnarray}
\begin{eqnarray}
	\label{eq:water_rel}
	\begin{gathered}
		k_{rg}=\left(1-\bar{S}_w\right)\frac{\mu_g}{\mu^*}\frac{\bar{v}_{g}}{\bar{v}_g^*} \frac{\Delta P^*}{\Delta P_g}
	\end{gathered}
\end{eqnarray}
\begin{eqnarray}
	\label{eq:sat_av}
