...
\begin{eqnarray}
	\label{eq:water_rel}
	\begin{gathered}
		k_{r0}=\bar{S}_0\frac{\mu_0}{\mu^*}\frac{\bar{v}_0}{\bar{v}^*} \frac{\Delta P^*}{\Delta P_0}
	\end{gathered}
\end{eqnarray}
\begin{eqnarray}
	\label{eq:water_rel}
	\begin{gathered}
		k_{r1}=\left(1-\bar{S}_0\right)\frac{\mu_1}{\mu^*}\frac{\bar{v}_{1}}{\bar{v}^*} \frac{\Delta P^*}{\Delta P_1}
	\end{gathered}
\end{eqnarray}
\begin{eqnarray}
	\label{eq:sat_av}
