...
\begin{gathered}
\bar{v}\bar{S}_w\frac{\bar{\mu}}{\mu_w} = -\frac{k k_{rw}}{\mu_w} \frac{\Delta P}{\Delta L}
\end{gathered}
\end{eqnarray}
...
\label{eq:gas_velocity}
\begin{gathered}
\bar{v} \left(1-\bar{S}_w\right)\frac{\bar{\mu}}{\mu_g} = -\frac{k k_{rg}}{\mu_g} \frac{\Delta P}{\Delta L}
\end{gathered}
\end{eqnarray}
...
\label{eq:water_rel}
\begin{gathered}
k_{rw}=\bar{S}_w\frac{\bar{\mu}}{\mu_g}\frac{\bar{v}}{v_g}
\end{gathered}
\end{eqnarray}
...
\label{eq:water_rel}
\begin{gathered}
k_{rg}=\left(1-\bar{S}_w\right) \frac{\bar{\mu}}{\mu_g}\frac{\bar{v}}{v_g}
\end{gathered}
\end{eqnarray}
...
\label{eq:twophase_dens_visc_model}
\begin{gathered}
\bar{v} = v^{\left(in\right)}\frac{\rho^{\left(in\right)}}{\bar{\rho}}.
\end{gathered}
\end{eqnarray}
